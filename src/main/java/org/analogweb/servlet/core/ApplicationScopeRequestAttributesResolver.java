 ...
 * @author snowgoose
 */
public class ApplicationScopeRequestAttributesResolver
		extends
			ContextSpecificAttributesHandler<ServletRequestContext> {

	private static final Log log = Logs
			.getLog(ApplicationScopeRequestAttributesResolver.class);

	@Override
	protected Object resolveAttributeValueOnContext(
			ServletRequestContext requestContext, InvocationMetadata metadata,
	...
	protected void putAttributeValueOnContext(
		...
		log.log(Markers.VARIABLE_ACCESS, "TV000001",
				ApplicationScopeRequestAttributesResolver.class
						.getCanonicalName(), name, value);
	}
